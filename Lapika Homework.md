...
1. Для того, чтобы начать работать с удалёнными репозиториями, необходимо зарегистрироваться на сервисе Github.com.
2. Если мы хотим скопировать себе уже существующий удалённый репозиторий на локальный носитель, команда _git clone URL_ позволяет это сделать. Вместо URL вставляем ссылку на удаленный репозиторий.
